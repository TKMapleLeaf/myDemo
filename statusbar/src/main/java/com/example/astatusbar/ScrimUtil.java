...
public class ScrimUtil {
    ...
    private static final LruCache<Integer, Drawable> INTEGER_DRAWABLE_LRU_CACHE = new LruCache<>(10);
    ...
    public static Drawable makeCubicGradientScrimDrawable(int baseColor, int numStops, int gravity) {
        ...
        Drawable cachedGradient = INTEGER_DRAWABLE_LRU_CACHE.get(cacheKeyHash);
        ...
        INTEGER_DRAWABLE_LRU_CACHE.put(cacheKeyHash, paintDrawable);
