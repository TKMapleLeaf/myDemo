...
package com.example.statusbar.statusbarutil;
...
public class ScrimUtil {
    ...
    public static Drawable makeCubicGradientScrimDrawable(int baseColor, int numStops, int gravity) {
        ...
        for (int i = 0; i < numStops; i++) {
            ...
            float opacity = MathUtil.constrain(0.5f, 1, (float) Math.pow(x, 3));
    ...
    public static Drawable makeGradientScrimDrawable(final int colorStart, final int baseColor, int numStops, int gravity) {
