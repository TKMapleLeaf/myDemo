...
public class TDevice {
    ...
    public static boolean isTablet() {
        int s = MyApplication.context.getResources().getConfiguration().screenLayout;
...
//            AppContext.showToast("你手机中没有安装应用市场！");
    ...
    public static int getVersionCode() {
        return getVersionCode(MyApplication.context.getPackageName());
    }
    ...
    public static String getVersionName() {
        try {
            return MyApplication.context
                    .getPackageManager()
                    .getPackageInfo(MyApplication.context.getPackageName(), 0)
                    .versionName;
        } catch (PackageManager.NameNotFoundException ex) {
