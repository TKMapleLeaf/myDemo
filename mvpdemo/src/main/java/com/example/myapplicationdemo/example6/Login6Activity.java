...
import com.example.myapplicationdemo.example6.base.BaseActivity;
...
public class Login6Activity extends BaseActivity<LoginView,LoginPresenter> implements LoginView, View.OnClickListener {
    ...
    public void success(Object o) {
        Toast.makeText(Login6Activity.this, "登录成功", Toast.LENGTH_SHORT).show();
    }

    @Override
    public void failure(String err) {
        Toast.makeText(Login6Activity.this, "登录失败", Toast.LENGTH_SHORT).show();
    }
}
